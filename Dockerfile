# --------------------------------------------------------------------
# | Env:
# | - WEBROOT            default is /var/www/html
# | - ERRORS             display php errors or not
# | - HIDE_NGINX_HEADERS display version details or not
# |
# |
# | Directories Usefuel:
# | - nginx     /etc/nginx/
...
# PHP.ini Configs Override Default Configs
ENV php_vars /usr/local/etc/php/conf.d/docker-vars.ini

# what nginx version to install
ENV NGINX_VERSION 1.13.6
# what lua-nginx module to install
...
#    sed -i -e "s/v3.4/edge/" /etc/apk/repositories && \
    ...
    libjpeg-turbo-dev && \
    #curl iconv session
    docker-php-ext-install mcrypt exif intl xsl json soap dom zip opcache && \
...
ADD conf/php/* /usr/local/etc/php/conf.d/
